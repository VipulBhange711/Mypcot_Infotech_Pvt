   ...
   <div class="row justify-content-center">
    <div class="col-lg-3 col-6">
        ...
        <div class="small-box gradient-1">
            ...
            <a href="{{route('CreateProject')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-6">
        ...
        <div class="small-box gradient-2">
            ...
            <a href="{{route('ViewList')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
    </div>
</div>
